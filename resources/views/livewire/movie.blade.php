        ...
        <div class="flex flex-col flex-1 w-full">
         ...
         <div class="max-w-sm rounded-lg border border-gray-200 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800">
          <a href='/movie/{{$item->id}}'>
            <img class="rounded-t-lg h-56 w-full" src="/img/{{$item->photo}}.jpg" alt="">
          </a>
          <div class="p-5">
            <a  href='/movie/{{$item->id}}'>
              <h5 class="mb-2 text-sm font-bold tracking-tight text-gray-900 dark:text-white">{{$item->name}}</h5>
            </a>
          </div>
        </div> 
